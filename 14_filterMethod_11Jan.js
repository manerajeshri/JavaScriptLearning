...
const arrayFilterEven = arrayOfNum.filter( ( currentValue,index)=> {
    ...
    //  console.log(arrayFilterVehical);
     arrayFilterVehical.forEach(( element)=>{
        console.log(element);// all array
console.log(element.company,element.price);// specific element
     } )
